            ...
            <div className="relative">
                ...
                <div className="absolute w-full flex flex-col items-center text-5xl text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 uppercase">
                    <div className="backdrop-grayscale px-6 py-6">
                        ...
                        <button className="mt-6 text-sm relative left-1/2 -translate-x-1/2 left border-2 border-white px-6 py-2 lg:px-14 inline-flex items-center justify-between lg:hover:bg-black duration-300">
                        Explore Store
