...
const Topbar = () =>{
    ...
    return(
            ...
            <div className="flex items-center justify-between text-gray-900">
              ...
              <button className="middle none center hidden rounded-lg bg-primary py-2 px-4 font-sans text-xs font-bold uppercase text-white lg:inline-block">
                Sign Out
              </button>
              <button className="middle ml-4 none center hidden rounded-lg bg-primary py-2 px-4 font-sans text-xs font-bold uppercase text-white lg:inline-block">
