          ...
          <div className="">
            <Banner />
              <div className="lg:flex items-center justify-between mt-10 px-6">
                ...
                <Products category={"tshirts"} imgUrl={"https://images.unsplash.com/photo-1541600779338-df49cc24f2c9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHRvcHMlMjBmb3IlMjB3b21lbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=600&q=60"}/>
              </div>
            <Footer />
          </div>
        </div>
