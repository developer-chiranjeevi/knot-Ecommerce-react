...
const Cart = () =>{
    ...
    return(
        <div className="">
            ...
            <div className={(navOpen?"block h-[calc(40vh)] w-full basis-full overflow-hidden text-blue-gray-900 transition-all duration-300 ease-in lg:hidden":"block h-[calc(0vh)] w-full basis-full overflow-hidden text-blue-gray-900 transition-all duration-300 ease-in lg:hidden")}>
